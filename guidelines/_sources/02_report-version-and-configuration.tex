...
Given suitable hardware, running the corresponding model in its default configuration is than as easy as executing \texttt{ollama run llama3.3:70b-instruct-q8\_0} (see Section \href{/guidelines/#use-an-open-llm-as-a-baseline}{Use an Open LLM as a Baseline}).
...
This guideline \must be followed for all study types for which the researcher has control over the model and its configuration.
