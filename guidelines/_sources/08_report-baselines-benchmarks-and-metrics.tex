...
LiveCodeBench \cite{DBLP:journals/corr/abs-2403-0797} & Code Generation & https://github.com/LiveCodeBench/LiveCodeBench
\hline

SWE-bench \cite{DBLP:conf/iclr/JimenezYWYPPN2} & Code Generation & https://github.com/swe-bench/SWE-bench
\hline
