...
When conducting any kind of empirical study involving LLMs, researchers \must clearly \textbf{declare} that an \textbf{LLM was used} in a suitable section of the \paper~(e.g., in the introduction or research methods section).
...
Beyond generic authorship declarations and declarations that LLMs were used as part of the research process, researchers \should report the \textbf{exact purpose} of using an LLM in a study, the \textbf{tasks} it was used to automate, and the \textbf{expected benefits} in the \paper.
