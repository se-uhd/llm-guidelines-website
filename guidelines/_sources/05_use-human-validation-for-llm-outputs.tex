...
%Neil: I don't get where this fits in the guideline. Machine measures are not LLM outputs, so I don't get the guideline here. Maybe something like "also consider metrics to validate ?"
...
\todo{Neil: I have put these next two into examples}
...
Khojah et al.~\cite{DBLP:journals/pacmse/KhojahM0N24} validated the results of their study using human measurement.
...
\todo{Neil: I don't understand the above. What is the LLM output being validated?}
...
\todo{Neil: also not an example of LLM output validation? To me this is more about using LLMs in studies}
