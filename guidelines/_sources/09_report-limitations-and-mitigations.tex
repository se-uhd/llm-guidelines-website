...
\textbf{Clear info:} 
\begin{itemize}
  \item Number of repetitions (``When evaluating model performance, it is recommended to conduct multiple tests and average the results.'' https://huggingface.co/deepseek-ai/DeepSeek-R1#usage-recommendations), how were repetitions aggregated?, discuss limitations and mitigations
