...
\textbf{Reproducibility}:
\todo{Its evident, shall we really make it explicit here?}
...
The limitations and mitigations SHOULD be followed for all study types in a sensible manner depending on the applicability to the individual study.
