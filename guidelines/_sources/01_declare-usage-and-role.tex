...
\comment{For example, Ludos et al. could be cited (already included in the references: "Leveraging LLMs for the quality assurance of software requirements" bibid DBLP:conf/re/LubosFTGMEL24) with a statement such as: "An example of LLM disclosure can be found in Ludos et al., which, in the methodology section, states: 'We conducted an LLM-based evaluation of requirements utilizing the Llama 2 language model [10] with 70 billion parameters, fine-tuned to complete chat responses....'"}
