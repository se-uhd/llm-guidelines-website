...
Moreover, even if a given version of a given LLM is likely to be deterministic, this is not the case for all of them (e.g. [discussion about GPT 4](https://152334h.github.io/blog/non-determinism-in-gpt-4/)). Moreover, for somebody reading the paper at a later point there is no guarantee that the specific version that was used to generate the prompts in the first place will be available. 
