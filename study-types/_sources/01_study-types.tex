...
Their use can benefit a wide range of empirical research methods: in controlled experiments, LLMs provide reproducibility and precise manipulation of variables; in interviews and surveys, they can simulate diverse respondent profiles, supporting scalability and consistency in data collection; in data mining and simulation studies, they serve as controlled agents capable of generating synthetic data or simulating complex behaviors. Overall, employing LLMs enhances the scalability and repeatability of empirical studies, while enabling the systematic exploration of diverse simulated user personas and behaviors—something often impractical with human subjects.
