...
\todo{Feedback Lutz: ``I have not analyzed this in detail, but it seems to me as if the mission here is unclear: Are we talking about research quality issues or about engineering usefulness or both? And what is the point of reference? For example, under Advantages it might be worth stating that LLM-based tools are easier to build than conventional static analysis tools (from an engineering usefulness perspective).''}
