...
\begin{itemize}
    ...
    \item Comprehensive evaluations demonstrate ChatGPT's potential as a general-purpose annotator, achieving particularly strong performance in sentiment analysis (64.9\% accuracy) and in detecting responses that challenge hate speech (0.791 precision for counterspeech detection)~\cite{DBLP:journals/corr/abs-2304-10145}.
\end{itemize}
...
\begin{itemize}
    ...
    \item Significant performance inconsistencies for post-training events and complex tasks, with ChatGPT showing notable disparities in performance across different label categories and struggling with newer topics such as the Russo-Ukrainian conflict sentiment analysis~\cite{DBLP:journals/corr/abs-2304-10145}.
    \item Systematic biases in label assignment have been observed, with LLMs sometimes showing a tendency to overestimate certain labels and misclassify neutral content, particularly in stance detection tasks~\cite{DBLP:journals/corr/abs-2304-10145}.
\end{itemize}
