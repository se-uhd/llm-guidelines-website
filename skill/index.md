...
The bundle ships a structured set of Markdown files. The first column links to the rich rendering on this website (where one exists); the second column links to the raw Markdown source in the skill repository.
