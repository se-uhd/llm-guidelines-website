...
\usepackage[main=english]{babel} % adjust language depending on thesis language (affects hyphenation)
...
\newcommand{\modelversionsummary}{\input{_guidelines/02_report-model-version-configuration-and-customizations-summary_markdown.tex}}
\newcommand{\judgesexample}{\input{_studytypes/01-02-llms-as-judges-example_markdown.tex}}
