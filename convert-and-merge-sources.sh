...
<div class="filter-grid">
<label title="Study benchmarks LLMs for software engineering tasks."><input type="checkbox" class="cond-filter" data-condition="benchmarking" checked> benchmarking</label>
